  ...
  return (
    <section className='relative h-screen w-full overflow-hidden pt-4 text-white'>
      <div className="relative flex size-full items-center justify-center">
        ...
        <div className="fixed bottom-0 flex w-full items-center justify-center gap-5 flex-wrap px-3">
          ...
          <CallStatsButton />
          <button onClick={() => setShowParticipants((prev) => !prev)} className='rounded-2xl bg-[#19232d] px-4 py-2 hover:bg-[#4C535B] cursor-pointer'>
